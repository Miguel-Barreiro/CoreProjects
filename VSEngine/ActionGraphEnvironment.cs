...
namespace Core.VSEngine
{
    public abstract class ActionGraphEnvironment
    {
        ...
        public abstract void InjectNode(ActionGraph actionGraph, Node node, IEnumerable<IActionGraphContext> contexts);
        ...
        /// </summary>
        /// <param name="contexts"></param>
        public virtual void PrepareFirstExecution(IEnumerable<IActionGraphContext> contexts)
        {
