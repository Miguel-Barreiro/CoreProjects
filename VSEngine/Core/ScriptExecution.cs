...
namespace Core.VSEngine
{
    public sealed class ScriptExecution
    {
        ...
        {
            return NodeScriptExecutionVariables.TryGetValue(name, out object? value) ? value : null;
        }
        ...
        public object? GetVariable(VSNodeBase owner, string name)
        {
            bool containsKey = NodeScriptNodeVariables.ContainsKey(owner);
            if (containsKey)
            {
                return NodeScriptNodeVariables[owner]!.TryGetValue(name, out object? value) ? value : null;
            }
            return null;
        }
