...
namespace Core.View
{
    ...
    //     {
    //         uint topIndex = componentContainer.TopEmptyIndex;
    //         for (int i = 0; i < topIndex; i++)
    //         {
    //             ref KineticComponentData kineticComponentData = ref componentContainer.Components[i];
    //             EntId entityID = kineticComponentData.ID;
    //             
    //             kineticComponentData.Rigidbody
